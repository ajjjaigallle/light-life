...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 6729;
        $headers['auth']['clientCompany'] = "YaXxjjQkICvEPPBrfmC8";
        $headers['auth']['clientSecret'] = "NjcyOVlhWHhqalFrSUN2RVBQQnJmbUM4Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
